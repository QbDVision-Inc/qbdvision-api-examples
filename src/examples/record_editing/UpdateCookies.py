...
with open('Make Cookies.json') as input_file:
    ...
    try:
        ...
        req = urllib.request.Request(f"{QBDVISION_URL}/editables/UnitOperation/{UNIT_OPERATION_ID}/{PROJECT_ID}", None, HEADERS, None, False, "GET")
    ...
    unitOperation["name"] = riffynStep["step_name"] + " 2"; # QbDVision won't allow updates without changes.
